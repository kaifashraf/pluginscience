...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-plugin-light flex flex-col md:flex-row">
        ...
        <div className="relative z-10">
          <Link href="/" className="inline-flex items-center gap-2 group">
            <span className="font-display text-2xl font-bold tracking-[0.2em] text-plugin-light">
              PLUGIN<span className="text-theme-data">.</span>
            </span>
          </Link>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="mb-10">
            ...
            <p className="text-sm text-plugin-text-muted">Access your dashboard</p>
          </div>
          ...
          <p className="text-center text-sm text-plugin-text-muted mt-12">
            ...
            <Link href="/signup" className="text-plugin-dark font-medium hover:text-theme-data transition-colors">
              Create one
            </Link>
          </p>
        </motion.div>
